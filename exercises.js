...
function map(arr, cb) {
	//create a new array
	//iterate over each value in arr, pass it to cb, 
	//then place the value returned from cb into the new arr
...
function addPrototypeMethod(Constructor) {
	...
	//the method should be called 'sayHi' 
	//and should return the string 'Hello World!'
...
function addReverseString() {
	...
	// SIMPLEST WAY >> this.split('').reverse().join('');
...
function cacheFunction(cb) {
	...
	//if the function you return is invoked with 5 
	//it would pass 5 to cb(5) and return 25
	//if the function you return is invoked again with 5 
	//it will look on an object in the closure scope
